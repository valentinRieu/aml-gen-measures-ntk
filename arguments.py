...
def get_arguments():
    ...
    parser.add_argument('--weight-decay', type=float, default=0.001, help='weight decay for optimizer (default: 0.001)')

    parser.add_argument('--learning-rate', type=float, default=-1, help='learning rate (default: 0.01)')
    # parser.add_argument('--no-save', action='store_true', default=False, help='disables all saving and measure computation')
    parser.add_argument('--save-every', type=int, default=1, help='Compute measurements after the n epoch (default: 1)')
